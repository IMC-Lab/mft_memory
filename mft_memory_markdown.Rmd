...
encoding_behav <- filter(encoding_behav_all, vigfile != 99999)
...
mean_brain_scores <- read.csv('data/PLS/brain_scores.csv')
...
upper_CIs <- read.csv('data/PLS/upper_CIs.csv')
lower_CIs <- read.csv('data/PLS/lower_CIs.csv')
...
```{r, fig.width=5, fig.height=5}
LV1 <- read.csv('data/PLS/temporal_brainscores_LV1_all.csv')
LV2 <- read.csv('data/PLS/temporal_brainscores_LV2_all.csv')
