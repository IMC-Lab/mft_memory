...
emmeans(modelMoral, ~ category) %>% contrast(method = 'pairwise', by = 'category', adjust='bonferroni')
...
tab_model(em_category,
          #file = 'Emotion&Empathy*Foundation.html',
          digits = 3, 
...
ggplot(anger_trends, aes(x=angry, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Anger (scaled)', tag = 'A.', title = 'Anger') +
...
ggsave('figures/paper/plot_anger.png', dpi = 300, width = 13)
contrast(anger.emt)
...
ggplot(amusement_trends, aes(x=amused, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Amusement (scaled)', tag = 'B.', title = 'Amusement') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_amusement.png', width=13, dpi = 300)
contrast(amusement.emt)
...
ggplot(sadness_trends, aes(x=sad, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Sadness (scaled)', tag = 'C.', title = 'Sadness') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_sadness.png', width = 13, dpi = 300)
contrast(sadness.emt)
...
ggplot(fear_trends, aes(x=afraid, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Fear (scaled)', tag = 'D.', title = 'Fear') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_fear.png', width = 13, dpi = 300)
contrast(fear.emt)
...
ggplot(contempt_trends, aes(x=contemptuous, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Contempt (scaled)', tag = 'E.', title = 'Contempt') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_contempt.png', width = 13, dpi = 300)
contrast(contempt.emt)
...
ggplot(disgust_trends, aes(x=disgusted, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Disgust (scaled)', tag = 'F.', title = 'Disgust') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_disgust.png', width = 13, dpi = 300)
contrast(disgust.emt)
...
ggplot(personalDistress_trends, aes(x=PersonalDistressScore, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Personal Distress (scaled)', tag = 'G.', title = 'Personal Distress') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_personalDistress.png', width = 13, dpi = 300)
contrast(PD.emt)
...
ggplot(empathicConcern_trends, aes(x=EmpathicConcernScore, y=emmean,ymin=lower.CL, ymax=upper.CL)) +
  ...
  MFT_color() + MFT_fill() +
  theme_pubr(legend = 'none') +
  labs(y='Moral judgment', x='Empathic Concern (scaled)', tag = 'H.', title = 'Empathic Concern') +
  theme(axis.text = element_text(size=10),
        plot.title = element_text(size = 16, hjust = 0.5, face = 'bold'),
        strip.background = element_rect(color = 'black', fill='gray99', size = 0.25),
        strip.text = element_text(face = 'bold', size = 12),
        ...
        axis.line = element_line(size = 0.25),
        text = element_text(family = 'Times New Roman'))
ggsave('figures/paper/plot_empathicConcern.png', width = 13, dpi = 300)
contrast(EC.emt)
```
