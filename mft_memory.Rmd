...
```{r plot em category trends, echo=FALSE, fig.width = 10, fig.height = 12, include=FALSE}
...
angerPlot <- ggplot(anger, aes(x=category, y=angry.trend, color=category)) +
  ylim(-0.5, 0.75) +
  geom_hline(aes(yintercept = 0.123), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
...
amusementPlot <- ggplot(amusement, aes(x=category, y=amused.trend, color=category)) +
  ylim(-0.5, 0.75) + 
  geom_hline(aes(yintercept = -0.100), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
  theme(axis.text = element_text(size = 10),
...
sadnessPlot <- ggplot(sadness, aes(x=category, y=sad.trend, color=category)) +
  ylim(-0.5, 0.75) +
  geom_hline(aes(yintercept = 0.044), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
  theme(axis.text = element_text(size = 10),
...
fearPlot <- ggplot(fear, aes(x=category, y=afraid.trend, color=category)) +
  ylim(-0.5, 0.75) +
  geom_hline(aes(yintercept = -0.009), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
  theme(axis.text = element_text(size = 10),
...
contemptPlot <- ggplot(contempt, aes(x=category, y=contemptuous.trend, color=category)) +
  ylim(-0.5, 0.75) +
  geom_hline(aes(yintercept = 0.074), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
  theme(axis.text = element_text(size = 10),
...
disgustPlot <- ggplot(disgust, aes(x=category, y=disgusted.trend, color=category)) +
  ylim(-0.5, 0.75) +
  geom_hline(aes(yintercept = 0.159), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
  theme(axis.text = element_text(size = 10),
...
personalDistressPlot <- ggplot(PersonalDistress, aes(x=category, y=PersonalDistressScore.trend, color=category)) +
  ylim(-0.5, 0.75) + 
  geom_hline(aes(yintercept = 0.025), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
  theme(axis.text = element_text(size = 10),
...
empathicConcernPlot <- ggplot(EmpathicConcern, aes(x=category, y=EmpathicConcernScore.trend, color=category)) +
  ylim(-0.5, 0.75) + 
  geom_hline(aes(yintercept = 0.018), size=0.5) +
  geom_pointrange(aes(ymax=upper.CL, ymin=lower.CL), fatten = 6) +
  MFT_color() +
  theme_pubr(legend = 'none') +
...
((angerPlot | amusementPlot) /  (sadnessPlot | fearPlot) / (contemptPlot | disgustPlot) / (personalDistressPlot | empathicConcernPlot)) &
  plot_annotation(tag_levels = 'A', tag_suffix = '.') & 
  theme(text = element_text(family = 'Times New Roman'), plot.tag = element_text(size = 11))
  
ggsave('plot_emtrends.png', width = 13, height = 10, dpi = 400)
```
