...
p1 <- brain_scores(all_LV1, ~LV1, 'LV1: 26.99% crossblock variance, p<0.000')
p2 <- temporal_brain_scores(LV1_tbs)
p1 + p2 +
...
p3 <- brain_scores(all_LV2, ~LV2, 'LV2: 20.51% crossblock variance, p<0.010')
p4 <- temporal_brain_scores(LV2_tbs)
p3 + p4 +
  plot_layout(ncol = 2, nrow = 2, widths = c(2, 0.95), guides = 'collect') +
  plot_annotation(title = '') &
  theme(text = element_text(family = 'Times New Roman'), plot.tag = element_text(size = 11), plot.title = element_text(hjust=0.5))
