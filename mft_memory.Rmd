...
compare_performance(modelMoral, em_everything, em_category, modelMoralSup, modelMoralSupNew, bayesfactor = FALSE, rank = TRUE)
```

```{r make em comparison table}
compare_performance(modelNull, modelMoral, em_everything, em_category, bayesfactor = FALSE, rank = TRUE)
```
