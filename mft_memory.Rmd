...
temporal_brain_scores <- function(df) {
    ...
    scale_x_discrete(expand = c(0, 0, 0, 0.2), labels = c('TR1', 'TR2', 'TR3', 'TR4', 'TR5', 'TR6', 'TR7')) +
...
p1 <- brain_scores(all_LV1, ~LV1, 'LV1: 26.99% crossblock variance, p<0.001') + MFT_color() + MFT_fill()
...
## DIBS poster plots
brain_scores(all_LV1, ~LV1, '') + MFT_color() + MFT_fill() + 
  scale_x_discrete(breaks = c('Social Norms', 'Authority','Loyalty','Purity',
                              'Harm-Emo','Harm-Phys','Fairness', 'Liberty')) +
  theme(text = element_text(family='Avenir'),
        axis.text = element_text(size=16),
        axis.title.y = element_text(size=16))
ggsave('figures/poster/LV1.png', dpi = 'retina', width=10.5)

temporal_brain_scores(LV1_tbs) + MFT_color() + MFT_fill() +
  labs(title=NULL, y=NULL) +
  theme(text=element_text(family='Avenir'),
        axis.text = element_text(size=20),
        legend.position = 'none') 
ggsave('figures/poster/LV1_tbs.png', dpi='retina', width=5)
...
brain_scores(all_LV2, ~LV2, '') + MFT_color() + MFT_fill() + 
  scale_x_discrete(breaks = c('Social Norms', 'Authority','Loyalty','Purity',
                              'Harm-Emo','Harm-Phys','Fairness', 'Liberty')) +
  theme(text = element_text(family='Avenir'),
        axis.text = element_text(size=16),
        axis.title.y = element_text(size=16))
ggsave('figures/poster/LV2.png', dpi = 'retina', width=10.5)

temporal_brain_scores(LV2_tbs) + MFT_color() + MFT_fill() +
  labs(title=NULL, y=NULL) +
  theme(text=element_text(family='Avenir'),
        axis.text = element_text(size=20),
        legend.position = 'none') 
ggsave('figures/poster/LV2_tbs.png', dpi='retina', width=5)
...
ggplot(em_comp_moral.df, aes(x=Model, y=AIC, fill=Model)) +
  coord_cartesian(ylim = c(6700, 7200)) +
  scale_x_discrete(labels = c('Add.', 'Int.', 'Found.', 'Null', 'Em.')) + 
  geom_col(width=0.75) +
...
ggsave('figures/poster/AIC.png', width=6, height = 4)

ggplot(em_comp_moral.df, aes(x=Model, y=BIC, fill=Model)) +
  coord_cartesian(ylim = c(6800, 7200)) +
  scale_x_discrete(labels = c('Add.', 'Int.', 'Found.', 'Null', 'Em.')) + 
  geom_col(width=0.75) +
  scale_fill_manual(values = wes_palette("Darjeeling1")) +
  #scale_color_manual(values = wes_palette("Darjeeling1")) + 
  ...
  labs(x=NULL, y=NULL) +
  theme(text=element_text(family = 'Avenir', size=16))
ggsave('figures/poster/BIC.png', width=6, height = 4)

ggplot(em_comp_moral.df, aes(x=Model, y=R2_conditional, fill=Model)) +
  ...
  labs(x=NULL, y=NULL) +
  theme(text=element_text(family = 'Avenir', size=16))
ggsave('figures/poster/R2.png', width=6, height = 4)

ggplot(em_comp_moral.df, aes(x=Model, y=RMSE, fill=Model)) +
  ...
  labs(x=NULL, y=NULL) +
  theme(text=element_text(family = 'Avenir', size=16))
ggsave('figures/poster/RMSE.png', width=6, height = 4)
```
